...
int main(int argc, char* argv[]) {
  ...
  ImagePPM test = ImagePPM("/home/vagrant/src/mp-seam-carving-twwoods2/images/image1.ppm");
  SeamCarver test_two = SeamCarver(test);
  std::cout << test_two.GetEnergy(2,2) << std::endl;
